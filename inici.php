...
if (!isset($_SESSION["sessionCaducada"])) {
  $_SESSION["sessionCaducada"] = false;
}
...
<body>
  ...
  <a href="https://github.com/Sapasus74"><img class="logo_github" src="Fotos/github-mark-white.png"></a>
    ...
    <?php
     if ($_SESSION["sessionCaducada"]) {
       echo "<p style='color: #00ff00;'>La session se ha cerrado por inactividad</p>";
       $_SESSION["sessionCaducada"] = false;
  } 
    if ($_SESSION["error"]) {
    ...
    ?>
    <form action="validacionInici.php" method="POST">
